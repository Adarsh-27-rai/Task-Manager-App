...
const About = () => {
  return (
    <div className='bg-gray-300 h-screen w-screen relative'>
      ...
      <img src="src/assets/task icon.png" alt="png" className='h-100 absolute right-15 top-50'/>
      <img src="src/assets/8kdb39e5o0n7ocjtpfrvduecsd.png" alt="logo" className='h-14 absolute left-5 top-10'/>
    </div>
  )
}
